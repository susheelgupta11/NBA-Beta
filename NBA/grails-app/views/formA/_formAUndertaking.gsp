...
<li> <span><input type="checkbox" name="conditionOfAbs" checked="true"  class="pull-left" /> &nbsp;</span><span>I have read and understood the terms and conditions of ABS guidelines and I undertake to abide by 
relevant legal provisions applicable to biological resources </span> </li>
</g:if>
<g:else>
...
relevant legal provisions applicable to biological resources  </li>
</g:else>

<g:if test= "${appFormId?.approvalOfNba == true }">
<li> 
<%--	<input type="checkbox" name="approvalOfNba" checked="true"  class="pull-left" />--%>
	 &nbsp;<span>I understood to obtain the approval of the NBA/SBB before making any change in the stated purpose</li>
</g:if>
<g:else>
<li> 
<%--	<input type="checkbox" name="approvalOfNba" class="pull-left" /> --%>
&nbsp;<span>I understood to obtain the approval of the NBA/SBB before making any change in the stated purpose</li>
</g:else>

<g:if test= "${appFormId?.recordsWithTheNba == true }">
<li> 
<%--	<input type="checkbox" name="recordsWithTheNba" checked="true"  class="pull-left" /> --%>
&nbsp;<span>I undertake to furnish/share the relevant records with the NBA / SBB, as and when required.</li>
</g:if>
<g:else>
<li> 
<%--	<input type="checkbox" name="recordsWithTheNba" class="pull-left" /> --%>
&nbsp;<span>I undertake to furnish/share the relevant records with the NBA / SBB, as and when required.</li>
</g:else>

<g:if test= "${appFormId?.infromationTrue == true }">
<li> 
