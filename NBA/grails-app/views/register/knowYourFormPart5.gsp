...
<%--					</div>--%>
				...
				<g:link controller="login" action="auth" class="btn btn-primary pull-left" params='[]'>Back</g:link>
					<%--<g:if test="${formNumber == 'form1'}">
						<g:link controller="applicationManagement"
							action="selectIndividualOrCompany" params="[formType:'Form1']"
							class="btn btn-primary pull-right">OK</g:link>
					</g:if>
					<g:elseif test="${formNumber == 'form2'}">
						<g:link controller="applicationManagement"
							action="selectIndividualOrCompany" params="[formType:'Form2']"
							class="btn btn-primary pull-right">OK</g:link>
					</g:elseif>
					<g:elseif test="${formNumber == 'form3'}">
						<g:link controller="applicationManagement"
							action="selectIndividualOrCompany" params="[formType:'Form3']"
							class="btn btn-primary pull-right">OK</g:link>
					</g:elseif>
					<g:elseif test="${formNumber == 'form4'}">
						<g:link controller="applicationManagement"
							action="selectIndividualOrCompany" params="[formType:'Form4']"
							class="btn btn-primary pull-right">OK</g:link>
					</g:elseif>
