...
<script type="text/javascript">
	$(document).ready(
			function() {
				AddActiveClass("form1Payment", "applicationManagement",
						"?formType=Form1");
			});
</script>
</head>
				...
				<div class="col-sm-12">
					<div class="checkout-wrap">
						<ul class="checkout-bar">
							...
							<li class="previous visited first"><a href="#">Step 1</a></li>

							<li class="previous visited">Step 2</li>

							<li class="previous visited">Step 3</li>
