...
$(document).ready(function() {		
	if(declaration!="")
	{
	appFormId=appFormId+'&declaration='+declaration;
	}	
	addCompletegreenClass(tabStatus);
	form2Part5(appFormId);
...
<div class="col-sm-12">
							...
							<div class="col-sm-12">
								<ul>
									...
									<li><b>Collection of proposed biological resources shall not
										pose any risk to ecosystems.</b></li>
									<li><b>Collection of proposed biological resources shall not
										adversely affect the local communities.</b></li>
								</ul>
							</div>
						...
						<div id="declarestatement" class="col-sm-12 form-group">
							...
							<h5>
								<g:checkBox class="checkbox" type="checkbox" checked="true" name="submitCheck"
									onclick="DisableSumitbtn(this)" /> &nbsp; I / We further
								declare that information provided in the application form is
								true and correct and I / we shall be responsible for any
							...
							<g:link controller="applicationManagement" id= "preview"
									class="btn btn-primary preview" action="form1preview" disabled= "true"
