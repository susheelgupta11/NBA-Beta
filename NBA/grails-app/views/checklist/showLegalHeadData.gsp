                       ...
                       <g:hiddenField name="counterVal" id="setCounter" value="" />
						<div class="col-sm-12 form-group">
						 <input type="submit" class="btn btn-primary pull-right"
								value="Update" onclick="setAllData()"/>
								
							<g:link controller="checklist" class="btn btn-primary pull-right"
								action="legalCheckList" target="_blank"
								params="${[remark:formRemkInstance?.id,instance:formDetails?.id,csrfPreventionSalt:csrfPreventionSalt]}"
								style="margin-right: 15px;">Generate Pdf</g:link>
						</div>
					</g:form>
