						...
						<g:form name="checklistNote" controller="checklist"
							...
							<thead>
								...
								<tr id="rec-3">
									...
									<td><g:textField class="remark" name="trsnsRemark" value="${accountRemarkInstance?.trsnsRemark}"/></td>
								</tr>
								<tr>
									...
									<td><g:textField class="remark" name="paymentRemark" value="${accountRemarkInstance?.paymentRemark}"/></td>
								</tr>
								<tr>
									<td><b>5</b></td>
									...
									<td><g:textField class="remark" name="paymentReceivedRemark" value="${accountRemarkInstance?.paymentReceivedRemark}"/></td>
								</tr>
								<tr>
									<td><b>6</b></td>
									...
									<td><g:textField class="remark" name="feeRemark" value="${accountRemarkInstance?.feeRemark}"/></td>
								</tr>
								...
								<tr>
									...
									<td style="padding: 0;">
										<div>
											<g:textArea name="remarkBnk" id="remarkM"   class="remark"
												style="display: none;"
								...
								<tr>
									...
									<td class="text-center" style="width: 1px;"><b>:</b></td>
									<td style="padding: 0 10px;"><g:textArea
											name="quest" value="${accountRemarkInstance?.question }"
											style="width: 100%; display:none;"   class="remark"/></td>
									<g:if
										test="${accountRemarkInstance == null || accountRemarkInstance == ''}">
										<td>
<%--		        <input type="button" class="btn" id="add" value="Add Question" name="10" onclick="addQuestionTr(this);" />--%>
		       
		       <a class="btn btn-primary pull-right add-record" data-added="0"><i class="glyphicon glyphicon-plus"></i> Add Questions</a>
		        </td>
									</g:if>
									<g:else>
										<td>"${accountRemarkInstance}"</td>
									</g:else>
								</tr>
    ...
    <table id="sample_table">
      <tr id="">
       ...
       <td>:</td>
       <td><g:textArea name="ansValues" class="ans" style="width:100%"></g:textArea></td>
       <td><a class="btn btn-xs delete-record" data-id="0"><span class="btn btn-danger"><i class="fa fa-trash"></i> Remove Row</span></a></td>
							...
							<div class="col-sm-12 form-group">
								<g:actionSubmit type="button" class="btn btn-primary pull-right"
									value="Save" name="Save" action="saveAccountNote" />
						</div>
...
<%--								<g:hiddenField name="accountRemarkInstanceComment" value="${accountRemarkInstance?.id}" />--%>
