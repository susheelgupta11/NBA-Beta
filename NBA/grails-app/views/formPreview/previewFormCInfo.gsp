			...
			<table class="table table-bordered datatable">
				<tr>
					...
					<td colspan="4" class="text-center"><g:link
							...
							action="printCompleateCProject" target="_blank"
							params='[id:"${applicationform?.id}",csrfPreventionSalt:"${csrfPreventionSalt}"]'>
            Print Form
		...
		--%><div class="">
			<table class="table table-bordered datatable">
				<tr>
					<td colspan="4" class="text-center"><g:link
							controller="formPreview" class="btn btn-primary"
							action="printCompleteProjectC" target="_blank"
							params='[id:"${applicationform?.id}",csrfPreventionSalt:"${csrfPreventionSalt}"]'>
            Print Form
	</g:link> </td>
				</tr>
