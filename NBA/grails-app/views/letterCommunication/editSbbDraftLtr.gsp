					...
					<div class="col-sm-12">
						<div class="panel panel-default">
							<div class="panel-body message" style="margin-left: 20px;">
								...
								<g:form controller="letterCommunication"  action="saveSbbLetter" enctype="multipart/form-data" method="POST">
									<g:render template="/letterCommunication/sbbckeditor"></g:render>
                    <%-- <g:hiddenField name="sbbConsentInstance" value="${sbbConsentInstance?.id}"/>--%>
                             <g:if test="${status == 'true'}">
                            <g:actionSubmit value="Send to SBB" class="btn btn-primary pull-right" style="margin-left: 15px;" action="sendSbbLetter"/>
                            <g:actionSubmit value="Resend to Draft" action="saveSbbLetter" class="btn btn-primary pull-right"/>
                             </g:if>
                                <g:else>
