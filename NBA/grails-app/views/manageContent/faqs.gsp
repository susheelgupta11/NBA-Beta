...
<div class="col-sm-9">
<g:form controller="manageContent" action="saveFaqs">
    <input type="hidden" name="csrfPreventionSalt" value="${csrfPreventionSalt}"/>
    <div id="froala-editor" class=" text-center">
        <p>You can edit the <b>FAQs</b> from here.</p>

<%--        <p>Total characters: <label id="charCount"></label></p>--%>
    </div>

   <div id="editor" class="form-group">
        <g:textArea id='edit' autocomplete="off" name="faqs" value="${faqS?.faq }" style="margin-top: 30px;">

        </g:textArea>
       </div>
       <div class="col-sm-12 text-center">
    <input type="hidden" name="faqId" value="${faqS?.id}"/>
