...
<%--				</div>--%>
				...
				<div class="main-registeration col-sm-12">
					...
					<g:if test="${formType == 'FormB'}">
						<modalbox:createLink action="previewFormBInfo"
							controller="formPreview" title="Form B Preview" width="1000" params= '[csrfPreventionSalt:"${csrfPreventionSalt}"]'
				...
				action="formBPart5"
								params='[formType:formType,appFormId:appForm?.id,csrfPreventionSalt:"${csrfPreventionSalt}"]'>Go back to Submit</g:link>
