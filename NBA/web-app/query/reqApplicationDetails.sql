SELECT DISTINCT ON (af.app_number) af.id,af.app_number, FC.Category, NU.name as received_from,app_status.changed_on,
app_status.status,app_status.priority,app_status.action_for,app_status.status_update,app_status.link_officer_check,
