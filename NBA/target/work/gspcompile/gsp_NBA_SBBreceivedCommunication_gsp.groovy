...
class gsp_NBA_SBBreceivedCommunication_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/SBB/receivedCommunication.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('remoteLink','g',67,['action':("viewLetterDetails"),'controller':("LetterCommunication"),'title':("Check letter Details"),'params':([editId:commDaitls?.id,csrfPreventionSalt:csrfPreventionSalt]),'data-target':("#success"),'data-toggle':("modal"),'update':("nin")],4)
printHtmlPart(16)
j++
}
}
...
public static final long LAST_MODIFIED = 1648425825304L
