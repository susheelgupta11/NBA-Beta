...
class gsp_NBA_applicationManagementform1Part1_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/applicationManagement/form1Part1.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',72,['class':("form-horizontal"),'role':("form"),'name':("profileTypeForm"),'autocomplete':("off"),'controller':("applicationManagement"),'action':("selectProfileType")],2)
printHtmlPart(10)
})
