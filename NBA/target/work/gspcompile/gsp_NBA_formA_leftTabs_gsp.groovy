...
class gsp_NBA_formA_leftTabs_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/formA/_leftTabs.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',153,['controller':("form4"),'action':("part5"),'class':("list-group-item himanshu"),'params':([formType:formType])],2)
printHtmlPart(14)
}
printHtmlPart(22)
...
printHtmlPart(23)
createClosureForHtmlPart(3, 2)
invokeTag('link','g',157,['controller':("applicationManagement"),'action':("depositionOfMicroOrganism"),'class':("list-group-item menu1 addinactive"),'params':([formType:formType,appFormId:appForm?.id,csrfPreventionSalt:"${csrfPreventionSalt}"])],2)
printHtmlPart(4)
createClosureForHtmlPart(5, 2)
invokeTag('link','g',161,['controller':("applicationManagement"),'action':("formCPart2"),'class':("list-group-item addinactive menu2"),'params':([formType:formType,appFormId:appForm?.id,csrfPreventionSalt:"${csrfPreventionSalt}"])],2)
printHtmlPart(2)
createClosureForHtmlPart(6, 2)
invokeTag('link','g',170,['controller':("applicationManagement"),'action':("formCPart3"),'class':("list-group-item addinactive menu2"),'params':([formType:formType,appFormId:appForm?.id,csrfPreventionSalt:"${csrfPreventionSalt}"])],2)
printHtmlPart(4)
createClosureForHtmlPart(7, 2)
invokeTag('link','g',175,['controller':("applicationManagement"),'action':("formCPart4"),'class':("list-group-item addinactive menu2"),'params':([formType:formType,appFormId:appForm?.id,csrfPreventionSalt:"${csrfPreventionSalt}"])],2)
printHtmlPart(16)
}
printHtmlPart(24)
}
