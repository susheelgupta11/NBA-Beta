...
class gsp_NBA_applicationManagement_leftTabs_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/applicationManagement/_leftTabs.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',31,['controller':("formA"),'action':("form1FormA"),'class':("list-group-item addinactive menu6"),'params':([formType:formType,appFormId:appForm?.id,csrfPreventionSalt:"${csrfPreventionSalt}"])],3)
printHtmlPart(8)
}
printHtmlPart(4)
...
invokeTag('link','g',36,['controller':("applicationManagement"),'action':("form1Part5"),'class':("list-group-item addinactive menu5"),'params':([formType:formType,appFormId:appForm?.id,declaration:"declaration",csrfPreventionSalt:"${csrfPreventionSalt}"])],3)
printHtmlPart(4)
}
else if(true && (appForm?.isDeclarationDigitallySigned == 'notDigital')) {
printHtmlPart(2)
createClosureForHtmlPart(10, 3)
invokeTag('link','g',42,['controller':("applicationManagement"),'action':("form1Part5"),'class':("list-group-item addinactive menu5"),'params':([formType:formType,appFormId:appForm?.id,declaration:"declaration",csrfPreventionSalt:"${csrfPreventionSalt}"])],3)
printHtmlPart(4)
}
else {
printHtmlPart(2)
createClosureForHtmlPart(10, 3)
invokeTag('link','g',46,['controller':("applicationManagement"),'action':("form1Part5"),'class':("list-group-item addinactive menu5"),'params':([formType:formType,appFormId:appForm?.id,csrfPreventionSalt:"${csrfPreventionSalt}"])],3)
printHtmlPart(4)
}
printHtmlPart(11)
}
...
printHtmlPart(2)
createClosureForHtmlPart(3, 3)
invokeTag('link','g',141,['controller':("formB"),'action':("researcherOrGovermentInst"),'class':("list-group-item menu1 addinactive"),'params':([formType:formType,appFormId:appForm?.id,csrfPreventionSalt:"${csrfPreventionSalt}"])],3)
printHtmlPart(4)
}
else if(true && (appForm?.indianResearcher?.size() > 0)) {
printHtmlPart(2)
createClosureForHtmlPart(3, 3)
invokeTag('link','g',146,['controller':("formB"),'action':("indianResearcher"),'class':("list-group-item menu1 addinactive"),'params':([formType:formType,appFormId:appForm?.id,csrfPreventionSalt:"${csrfPreventionSalt}"])],3)
printHtmlPart(4)
}
else if(true && (appForm?.indianGovtInst?.size() > 0)) {
printHtmlPart(20)
createClosureForHtmlPart(3, 3)
invokeTag('link','g',150,['controller':("formB"),'action':("indianGovtInst"),'class':("list-group-item menu1 addinactive"),'params':([formType:formType,appFormId:appForm?.id,csrfPreventionSalt:"${csrfPreventionSalt}"])],3)
printHtmlPart(4)
}
printHtmlPart(21)
createClosureForHtmlPart(5, 2)
invokeTag('link','g',153,['controller':("formB"),'action':("formBPart2"),'class':("list-group-item addinactive menu2"),'params':([formType:formType,appFormId:appForm?.id,csrfPreventionSalt:"${csrfPreventionSalt}"])],2)
printHtmlPart(4)
createClosureForHtmlPart(6, 2)
invokeTag('link','g',156,['controller':("formB"),'action':("formBPart3"),'class':("list-group-item addinactive menu3"),'params':([formType:formType,appFormId:appForm?.id,csrfPreventionSalt:"${csrfPreventionSalt}"])],2)
printHtmlPart(4)
createClosureForHtmlPart(7, 2)
invokeTag('link','g',159,['controller':("formB"),'action':("formBPart4"),'class':("list-group-item addinactive menu5"),'params':([formType:formType,appFormId:appForm?.id,csrfPreventionSalt:"${csrfPreventionSalt}"])],2)
printHtmlPart(22)
createClosureForHtmlPart(10, 2)
invokeTag('link','g',168,['controller':("formB"),'action':("formBPart5"),'class':("list-group-item himanshu menu4"),'params':([formType:formType,appFormId:appForm?.id,csrfPreventionSalt:"${csrfPreventionSalt}"])],2)
printHtmlPart(23)
}
printHtmlPart(24)
...
invokeTag('link','g',180,['controller':("applicationManagement"),'action':("depositionOfMicroOrganism"),'class':("list-group-item menu1 addinactive"),'params':([formType:formType,appFormId:appForm?.id,csrfPreventionSalt:"${csrfPreventionSalt}"])],2)
printHtmlPart(4)
createClosureForHtmlPart(5, 2)
invokeTag('link','g',184,['controller':("applicationManagement"),'action':("formCPart2"),'class':("list-group-item addinactive menu2"),'params':([formType:formType,appFormId:appForm?.id,csrfPreventionSalt:"${csrfPreventionSalt}"])],2)
printHtmlPart(2)
createClosureForHtmlPart(6, 2)
invokeTag('link','g',190,['controller':("applicationManagement"),'action':("formCPart3"),'class':("list-group-item addinactive menu3"),'params':([formType:formType,appFormId:appForm?.id,csrfPreventionSalt:"${csrfPreventionSalt}"])],2)
printHtmlPart(4)
createClosureForHtmlPart(7, 2)
invokeTag('link','g',195,['controller':("applicationManagement"),'action':("formCPart4"),'class':("list-group-item addinactive menu5"),'params':([formType:formType,appFormId:appForm?.id,csrfPreventionSalt:"${csrfPreventionSalt}"])],2)
printHtmlPart(16)
}
printHtmlPart(26)
}
