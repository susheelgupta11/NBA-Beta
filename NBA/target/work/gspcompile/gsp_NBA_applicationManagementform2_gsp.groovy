...
class gsp_NBA_applicationManagementform2_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/applicationManagement/form2.gsp" }
public Object run() {
Writer out = getOut()
